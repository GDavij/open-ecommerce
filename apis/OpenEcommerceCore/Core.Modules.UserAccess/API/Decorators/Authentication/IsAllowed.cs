...
internal class IsAllowed : Attribute, IAsyncAuthorizationFilter
{
    ...
    public async Task OnAuthorizationAsync(AuthorizationFilterContext context)
    {
        ...
        var authorizationResponse = await HandleAuthenticationForUserAccess(auth, cancellationToken); 
    ...
    private async Task<AuthenticationResult> HandleAuthenticationForUserAccess(string encodedToken, CancellationToken cancellationToken)
    {
                Token token;
