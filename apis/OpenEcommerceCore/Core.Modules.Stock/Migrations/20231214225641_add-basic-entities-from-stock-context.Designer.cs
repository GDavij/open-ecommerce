...
namespace Core.Modules.Stock.Migrations
{
    ...
    [Migration("20231214225641_add-basic-entities-from-stock-context")]
    partial class addbasicentitiesfromstockcontext
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Modules.Stock.Domain.Entities.Complex.Product.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Core.Modules.Stock.Domain.Entities.Complex.Product.ProductDetails.MeasurementDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Core.Modules.Stock.Domain.Entities.Complex.Product.ProductDetails.OtherDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Core.Modules.Stock.Domain.Entities.Complex.Product.ProductDetails.TechnicalDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Core.Modules.Stock.Domain.Entities.Complex.Product.ProductImage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("Id");
            ...
            modelBuilder.Entity("Core.Modules.Stock.Domain.Entities.Complex.Product.ProductTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Core.Modules.Stock.Domain.Entities.Complex.Product.ProductDetails.MeasurementDetail", b =>
                {
                    ...
                    b.HasOne("Core.Modules.Stock.Domain.Entities.Complex.Product.Product", "Product")
            ...
            modelBuilder.Entity("ProductProductTag", b =>
                {
                    b.HasOne("Core.Modules.Stock.Domain.Entities.Complex.Product.Product", null)
                        .WithMany()
                        .HasForeignKey("TaggedProductsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Modules.Stock.Domain.Entities.Complex.Product.ProductTag", null)
                        .WithMany()
